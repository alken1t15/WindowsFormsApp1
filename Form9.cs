...
{
    public partial class FormFinalTestDisign : Form
    {
        ...
        public FormFinalTestDisign(int count, string _testType)
        {
            InitializeComponent();
        ...
        private void FormFinalTestDisign_Load(object sender, EventArgs e)
        {
